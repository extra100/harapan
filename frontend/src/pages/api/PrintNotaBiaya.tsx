...
import { useGetPembiayaanByIdQuery } from '../../hooks/pembiayaanHooks'

const { Title, Text } = Typography

const PrintNotaBiaya = forwardRef<HTMLDivElement>((props, ref) => {
