...
console.log({simpanSisaPiutrang})
  ...
  const handleFormSubmit = (values: any) => {
    ...
    saveInvoiceData(allTransactions)
      .then(() => {
        message.success('Data transaksi berhasil disimpan.');
        return saveNextPayment(payload);
      })
      .then((response: any) => {
      ...
      .catch((error: any) => {
        ...
        message.error('Gagal menyimpan data atau pembayaran.');
      });
  };
//   const handleFormSubmit = (values: any) => {
//     const accountMap = fiAc?.children?.reduce((map: any, warehouse: any) => {
...
//     try {
//       if (!allTransactions) {
//         message.error('Tidak ada data transaksi yang ditemukan.');
//         return;
//       }

//       await saveInvoiceData(allTransactions);
