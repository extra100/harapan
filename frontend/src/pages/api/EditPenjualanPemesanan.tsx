...
//     any[]
//   >([])
// // const [financeAccountIds, setSelectedFinanceAccountIds] = useState<any[]>(financeAccountIds as any);

// console.log({financeAccountIds})
// console.log({selectedFinanceAccountId})
//   useEffect(() => {
//     if (user) {
...
//   const noIbo = getPosDetail?.memo || getPosDetail?.ref_number;
...
//         const matchingStock = productQuantities[item.finance_account_id] || financeAccountIds
...
// export default EditPenjualanPemesanan
<>
</>