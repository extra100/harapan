...
import { useAddPembiayaanHutangMutation } from '../../hooks/PembiayaanHutangHooks'

const PenambahanHutangKaryawan = () => {
  ...
  const addPosMutation = useAddPembiayaanHutangMutation()
...
export default PenambahanHutangKaryawan
