...
import { useAddPembiayaanMutation } from '../../hooks/pembiayaanHooks'
...
console.log({contacts})
  ...
  const addPosMutation = useAddPembiayaanMutation()
...
{Array.isArray(contacts) &&
  contacts
    ...
    .filter((contact) => contact.id_kontak === '67f0ebf43f8fdc66b1c1cc35') // 🔥 filter berdasarkan id_kontak
    .map((item) => (
        ...
        >
          ...
          <div>
            ...
            >
              ...
              <Row gutter={16} style={{ marginBottom: '10px' }}>
                <Col span={12}>
                  <span style={labelStyle}>Sumber Dana</span>
                  <span style={labelColonStyle}>:</span>
                  <Select
                    showSearch
                    value={selectedBank}
                  ...
                  >
                   {akunBanks
                  ?.filter((e) => e.id === 5) // Hanya ID 1 dan 2
                  .map((e) => (
...
export default PenambahanBiaya
